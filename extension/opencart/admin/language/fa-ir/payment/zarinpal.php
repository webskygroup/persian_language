...
// Heading
$_['heading_title']       = '<b style="color:#2131c6;">زرين پال</b>';

// Text 
$_['text_extension']   	  = 'افزونه ها';
$_['text_success']        = 'ماژول پرداخت زرين پال با موفقیت ویرایش شد!';
$_['text_zarinpal']  	  = '<a href="http://www.zarinpal.com" target="_blank"><img src="extension/opencart/admin/view/image/payment/zarinpal.gif" alt="زرين پال" title="زرين پال" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_edit']           = 'ویرایش پرداخت آنلاین زرين پال';
$_['text_support']        = 'پشتیبانی';
$_['text_support_title']  = 'اپن کارت فارسی دات کام';

// Entry
$_['entry_pin']   		  = 'کد دروازه پرداخت';
